...
<body id="page-top">
    ...
    $data10 = json_decode($data10, TRUE);
    foreach ($data10 as $total) : {
            $max = $max + $total['total'];
        }
    endforeach;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="highcharts-description">
                    Berikut Merupakan Shipmethod yang Paling Banyak Digunakan.
                </p>
                <!-- /.container-fluid -->
            </div>
            <!-- End of Main Content -->
    ...
    <script type="text/javascript">
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Shipmethod yang Paling Banyak Digunakan'
            },
            subtitle: {
